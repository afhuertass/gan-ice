...
class GAN():
    ...
    def generator_mlp(self ,z ):
        ...
        with tf.variable_scope("generator") as scope:
            ...
            lin3 = self.linear( lin2 , 75*75 , "g_lin3")
            print(lin3.shape)
            lin3 = tf.reshape( lin3 , [mb_size , 75,75] )
    ...
    def discriminator_mlp(self , x , reuse ) :
        ...
        with tf.variable_scope("discriminator") as scope:
            ...
            inputs = tf.reshape(x ,[mb_size , 75*75 ] )
            units1 = 75*75 
    ...
    def build_inputs_dis( self, band1 , band2 ):
         ...
         band1 = tf.reshape( band1  , [mb_size ,  75 , 75 ] )
         band2 =  tf.reshape( band2  , [mb_size ,  75 , 75 ] )
    ...
    def build(self , X  , global_step ):
        ...
        self.G_solver = tf.train.RMSPropOptimizer(
            learning_rate = 1e-5).minimize( self.G_loss , var_list = var_list_g , global_step = global_step )
